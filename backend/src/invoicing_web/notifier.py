...
class _NotifierSendError(Exception):
    """Internal error raised when a notifier HTTP request fails."""
...
class HttpNotifierSender:
    """HTTP notifier sender for email/SMS reminder dispatch."""
